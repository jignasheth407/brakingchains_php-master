  ...
  <body id="user">
      <section class="container">
          <div class="content row">
            ...
            <button type="button" class="login btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#invite">Resend Invite Email</button>
                    ...
                    <div class="modal-content">
                       ...
                       <!-- Modal Body -->
                        ...
                        <!-- Modal Footer -->
                            ...
                            <button type="submit" id="inviteSubmit" name="submit" class="btn btn-primary">Send</button>
                        </div><!--modal-footer-->
                    </div><!--modal-content-->
                </div><!--modal-dialog-->
