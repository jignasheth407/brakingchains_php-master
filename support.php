...
?>
  ...
  include "_/components/php/new_header.php"; ?>
  <style type="text/css">
    .modal-backdrop.show {
    opacity: 0 !important;
    }
          ...
          <div class="section">
            ...
            <div class="container clearfix">
              ...
              <div class="mx-auto center">
                ...
                <h2 class="font-weight-light ls1">My Family</h2>
              ...
              <div class="row grid-container" data-layout="masonry" style="overflow: visible">
                ...
                <?php 
                 ...
                 echo getFlowerContacts($connection, $tlf_id);
    ...
    $(".flip-card").mouseover(function(){
      ...
      var $container=$(this).find(".flip-card-inner").find("p.message");
         ...
         $.ajax({
                ...
                data: {action:'get_message',category:'family'},
                dataType:'json',
