...
<section class="container" ng-app="">
  <?php include "_/components/php/header.php"; 
    echo '<button type="button" class="btn btn-dark btn-block" href="seeds.php" onclick="location.href = \'myTrees.php\';">Back</button>';?>
    
    <h2><i class="fas fa-users"></i> MY INVITEES</h2>
<?php 
    $tlf_id = $_SESSION['tlf_id'];

 echo getContactInfoInvitees($connection, $tlf_id);
