...
$errors = array();
    ...
    $required_fields = array('first_name', 'last_name', 'email', 'phone', 'fireDate', 'referrer_name', 'ref_id', 'password', 'giftMethod', 'methodUsername');
    ...
    $giftMethod = trim($_REQUEST['giftMethod']);
    $methodUsername = trim($_REQUEST['methodUsername']);
