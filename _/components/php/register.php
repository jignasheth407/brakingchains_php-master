<!--
// register.php - called by the Onit5 website - index.php
// to present a form for new user registration
//
// (c) 2018, 5Onit
// Written by James Misa 
-->
<?php 
    $ref_id = $_SESSION['tlf_id'];
?>
<button type="button" 
        class="btn btn-block btn-primary" 
        data-toggle="modal" 
        data-target="#register">Sign Up NOW!</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label  class="sr-only" for="referrer_name"><?php echo $ref_name; ?></label>
                    <div class="col-sm-12" inputGroupContainer>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input type="text" class="form-control" 
                            id="referrer_name" name="referrer_name" value="<?php echo $ref_name; ?>"/>
                        </div><!--input-group-->
                    ...
                    <div class="form-group">
                        <div class="col-sm-12" inputGroupContainer>
                            <div class="input-group">
                                ...
                                id="air_id" name="air_id" value="'<?php echo $ref_id; ?>'" placeholder="Referrer Code" readonly/>
                            </div><!--input-group-->
                        </div><!--inputGroupContainer-->
                    </div><!--form-group-->
