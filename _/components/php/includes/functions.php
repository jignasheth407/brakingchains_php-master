...
function getNextGift($connection, $tlf_id) {
    ...
    while($found_user = mysqli_fetch_array($resultSet)) {
        ...
        $flower_contacts.='<div class="col-lg-4 mb-4">
                                                ...
                                                <div class="card bg-transparent border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="font-italic">Next Harvest : ' . $water .  ' </span>
                                                         <span class="font-italic">Next Harvest : ' . $display_name .  ' </span>
                                        ...
                                        <div class="flip-card-back" data-height-xl="200" style="background-image: url(\''.$harvest_back.'\')">
                                            <div class="flip-card-inner">
                                                ...
                                                <span class="font-italic"> ' . $water .  '</span><br />
                                                 <button class="btn profile-btn" data-toggle="modal" data-target="#harvestsModel'.$i.'">view Tree</button>
                                ...
                                <!-- Modal -->
  <div class="pl-0 modal fade" id="harvestsModel'.$i.'" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header justify-content-center">
          
          <h4 class="modal-title">Tree ID #91</h4>
        </div>
                                        ...
                                        <div class="flip-card-inner">
                                                <div class="card bg-transparent border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="font-italic">Last Harvest : ' . $display_name .  ' </span>
    ...
    while($found_user = mysqli_fetch_array($resultSet)) {
        ...
        $flower_contacts =' <div class="col-lg-4 mb-4">
                                            ...
                                            <div class="flip-card-inner">
                                                ...
                                                <div class="card bg-transparent border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="font-italic">Fire Date ' . $display_name . '</span>
                ...
                <div class="flip-card-back" data-height-xl="200" style="background-image: url(\''.$family_back.'\');"><div class="flip-card-inner">
                                                ...
                                                <button type="button" class="btn btn-outline-light mt-2 btn_view_detail_family" data-flower_id="'.$id.'" data-lotus_id="'.$lotus_id.'" data-water_id="'.$water_id.'"data-earth_id="'.$earth_id.'" data-air_id="'.$air_id.'" aria-expanded="true"  <button class="btn profile-btn" data-toggle="modal" data-target="#myModal-family1' . $i . '">view Tree</button>
          ...
          <div class="pl-0 modal fade dev bharat" id="myModal-family1' . $i . '" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="card-body">
            <h4 id="flowers-title" class="text-center">MY ROOTS</h4>
            <table class="table table-striped">
                                                <thead>
                                                    <tr>
                                                      <th scope="col">Pos</th>
                                                ...
                                                <tbody>';
        $flower_contacts = $flower_contacts . getContactInfo($connection, $water_id, 'Tree');
        $flower_contacts = $flower_contacts . getContactInfo($connection, $earth_id, 'Plant');
        $flower_contacts = $flower_contacts . getContactInfo($connection, $air_id, 'Seedling');
        $flower_contacts = $flower_contacts . '</tbody>
                                        </table>';
        
        $flower_contacts = $flower_contacts . '<h2 id="flowers-title">MY BRANCHES</h2>';
        $flower_contacts = $flower_contacts . '<table class="table table-striped">
                                                <thead>
                                                    <tr>
                                                      <th scope="col">Pos</th>
        ...
        while($found_earths = mysqli_fetch_array($resultSet2)) {
            $earth_lotus_id = $found_earths['lotus_id'];
            $position = 'Plant ' . $e;
            $flower_contacts = $flower_contacts . getContactInfo($connection, $earth_lotus_id, $position);
            $e++;
        }
        
        $query3 = "SELECT *";
        $query3 .= "FROM users ";
        $query3 .= "WHERE earth_id = '{$lotus_id}'";
        $resultSet3 = mysqli_query($connection, $query3);
        confirm_query($resultSet3, $connection);
        ...
        while($found_airs = mysqli_fetch_array($resultSet3)) {
            $air_lotus_id = $found_airs['lotus_id'];
            $position = 'Seedling ' . $a;
            $flower_contacts = $flower_contacts . getContactInfo($connection, $air_lotus_id, $position);
            $a++;
        }
        
        $query4 = "SELECT *";
        $query4 .= "FROM users ";
        $query4 .= "WHERE water_id = '{$lotus_id}'";
        $resultSet4 = mysqli_query($connection, $query4);
        confirm_query($resultSet4, $connection);
        ...
        while($found_fires = mysqli_fetch_array($resultSet4)) {
            $fire_lotus_id = $found_fires['lotus_id'];
            $position = 'Seed ' . $f;
            $flower_contacts = $flower_contacts . getContactInfo($connection, $fire_lotus_id, $position);
            $f++;
        }
    $flower_contacts = $flower_contacts . '</tbody>
                                        </table></div>
...
function getReferrerName($connection, $referrer_email) {
    $query = "SELECT *";
    $query .= "FROM users ";
    $query .= "WHERE email = '{$referrer_email}' LIMIT 1";
    $resultSet = mysqli_query($connection, $query);
    confirm_query($resultSet, $connection);
    
    $found_referrer = mysqli_fetch_array($resultSet);
    $name = $found_referrer['first_name'] . " " . $found_referrer['last_name'];
