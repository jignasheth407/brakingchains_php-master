...
$('#editSubmit').click(function(){
    ...
    alert(referrer_name);
        var tlf_id = $("#tlf_id").val();
        var dataString = 'first_name=' + first_name + '&last_name=' + last_name + '&email=' + email + '&phone=' + phone + '&referrer_name=' + referrer_name + '&tlf_id=' + tlf_id;
             jQuery.ajax({
                 type: "POST",
