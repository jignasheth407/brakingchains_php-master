...
<?php 
// user.php - called by the 5Onit website - header.php
...
<html lang="en">
  ...
  <body>
    ...
    <script src="_/components/js/jquery.rwdImageMaps.js"></script>
    <script src="_/components/js/javascript.js"></script>
  </body>
</html>